...
const Schema = Yup.object().shape({
	...
	preference: Yup.string().required(
		'Please choose your registration preference',
	),
	password: Yup.string().required('This field is required'),
	country: Yup.mixed().required('Please select country of operation'),
...
const SignUp = () => {
	...
	const registerUser = async (incomingData: any) => {
				...
				<>
					...
					<NoSsr>
						<ThemeProvider theme={theme}>
							<>
								<form className='w-100  px-3 px-lg-5'>
									{errorData.status && (
										<div>
									...
									<div className='form-row mt-2 mb-n3'>
										<ThemeProvider theme={theme}>
											<Field
												color='secondary'
												defaultChecked
